...
#--------------------------(COLOUR MIX)------------------------------#
os.system('clear')
print(f'\x1b[38;5;46mOPEN SOURCE BY SIFAT-404 x RIFAT-VAI143');time.sleep(1.5)
#--------------------------(COLOUR MIX)------------------------------#
#--------------------------(COLOUR BOX)--------------------------#    
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-open https://t.me/+KAkcUhyGuD4yMjQ1')
...
def v2():
    ...
    os.system('clear')
    print(logo)
    os.system('xdg-open https://t.me/+hGJ6R2PxfYsyMDY1')
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=40) as akash:
        os.system('clear')
        print(logo)
        tl = str(len(user))
